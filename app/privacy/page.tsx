  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12 md:py-16">
      ...
      <header className="mb-8">
        <h1 className="text-pretty text-3xl font-semibold tracking-tight md:text-4xl">Privacy Policy</h1>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-foreground/90">
        <section>
          <p className="text-pretty">
            ...
            Privacy Policy explains what information we access, how we use it, and the choices you have.
          </p>
        </section>

        <section>
          <h2 className="mb-3 text-lg font-semibold">Information we access</h2>
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              <span className="font-medium">Basic profile (name, email, picture):</span> shown in the app header so you
              can confirm which account is connected.
            </li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">How we store your data</h2>
          <ul className="list-disc space-y-2 pl-5">
            <li>
            ...
            <li>Chat conversations live only in your browser session and are cleared when you reset the chat or close the tab.</li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">Your choices</h2>
          <ul className="list-disc space-y-2 pl-5">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold">Data retention</h2>
          <p>
